 ...
 *
 */
public class InClinicEndAfterPayInfoNewPatientConfig {
	...
	@Test
	public void endAfterPayInfoNewPatSelect() throws Exception {
		...
		for(int i=1; i<=sheet2.getLastRowNum(); i++){
			...
			new Select(EregNavigationObjects.KioskEndpoint(driver)).selectByVisibleText("End after Payment Info - New Patient");
