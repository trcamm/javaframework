 ...
 *
 */
public class InClinicEndAfterMedsNewPatientConfig {
	...
	@Test
	public void endAfterMedsNewPatSelect() throws Exception {
		...
		for(int i=1; i<=sheet2.getLastRowNum(); i++){
			...
			new Select(EregNavigationObjects.KioskEndpoint(driver)).selectByVisibleText("End After Medications - New Patient");
