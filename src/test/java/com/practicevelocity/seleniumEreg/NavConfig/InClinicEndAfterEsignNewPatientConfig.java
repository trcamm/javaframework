 ...
 *
 */
public class InClinicEndAfterEsignNewPatientConfig {
	...
	@Test
	public void endAfterEsignNewPatSelect() throws Exception {
		...
		for(int i=1; i<=sheet2.getLastRowNum(); i++){
			...
			new Select(EregNavigationObjects.KioskEndpoint(driver)).selectByVisibleText("End After Esign - New Patient");
