 ...
 *
 */
public class InClinicMedSpringNewPatientConfig {
	...
	@Test
	public void medSpringNewPatSelect() throws Exception {
		...
		for(int i=1; i<=sheet2.getLastRowNum(); i++){
			...
			new Select(EregNavigationObjects.KioskEndpoint(driver)).selectByVisibleText("MedSpring Navigation");
