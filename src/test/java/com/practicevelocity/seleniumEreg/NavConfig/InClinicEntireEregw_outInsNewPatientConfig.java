 ...
 *
 */
public class InClinicEntireEregw_outInsNewPatientConfig {
	...
	@Test
	public void entireEregW_outInsNewPatSelect() throws Exception {
		...
		for(int i=1; i<=sheet2.getLastRowNum(); i++){
			...
			new Select(EregNavigationObjects.KioskEndpoint(driver)).selectByVisibleText("Entire eReg w/o Insurance - New Patient");
