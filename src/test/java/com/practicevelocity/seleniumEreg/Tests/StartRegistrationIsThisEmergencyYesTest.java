...
import com.practicevelocity.seleniumEreg.PageObjects.EregThisIsEmergencyObjects;
 ...
 *
 */
public class StartRegistrationIsThisEmergencyYesTest {
	...
	public void setupTest() throws Exception{
		...
		//caps.setCapability("name", "EregIsThisEmergencyYes");
	...
	@Test
	public void EregIsThisEmergencyYes() throws Exception {
		//Rest API's URL
		...
		EregThisIsEmergencyObjects.get_pin(driver).sendKeys(result);
		EregThisIsEmergencyObjects.insert_pin(driver).sendKeys(Keys.RETURN);

		//Select Is emergency 'Yes' navigate out eReg
		EregThisIsEmergencyObjects.yesEmergency_btn(driver).click();
		EregThisIsEmergencyObjects.SeeReceptionist_btn(driver).click();
		
		Assert.assertTrue(driver.getTitle().contains("Start Registration"),"Is Emergency session failed");
	} 
